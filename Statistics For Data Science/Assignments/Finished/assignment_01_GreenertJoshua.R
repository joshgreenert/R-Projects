...
week1_sleep <- c("Sunday" = 6.1, "Monday" = 8.8, "Tuesday" = 7.7, "Wednesday" = 6.4, "Thursday" = 6.2, "Friday" = 6.9, "Saturday" = 6.6)
print(week1_sleep)
...
week2_sleep <- c("Sunday" = 7.1, "Monday" = 7.4, "Tuesday" = 7.9, "Wednesday" = 6.5, "Thursday" = 8.1, "Friday" = 8.2, "Saturday" = 8.9)
print(week2_sleep)
...
ringbearers_df <- characters_df[characters_df$ring_bearer == 5,]
