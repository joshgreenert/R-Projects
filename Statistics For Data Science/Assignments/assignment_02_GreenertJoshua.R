...
## Use `setwd()` if needed
setwd("C:/Users/Josh/Documents/GitHub/R-Projects/Statistics For Data Science/data")
...
scores_df <- read.table("data/scores.csv")
print(summary(scores_df))

## Load the `readxl` library; The install.packages method was required to
## get the library to load in.
## install.packages("tidyverse") was neeeded for first-time installation.
library(`readxl`)
...
## install.packages("RSQLite") was neeeded for first-time installation.
